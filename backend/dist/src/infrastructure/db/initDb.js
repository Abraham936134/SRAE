...
async function init() {
    ...
    `;
        ...
        await (0, neon_1.default) `INSERT INTO criterios (id, rubrica_id, descripcion, ponderacion) VALUES (${crit1Id}, ${rubric1Id}, 'Claridad en la comunicación y dominio del tema', 40)`;
        const levels1 = [
        ...
        for (const l of levels1) {
            await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES (${l.id}, ${crit1Id}, ${l.desc}, ${l.pts})`;
        }
        // Rubric 1 - Criterion 2
        const crit2Id = '22222222-2222-2222-2222-111111111111';
        await (0, neon_1.default) `INSERT INTO criterios (id, rubrica_id, descripcion, ponderacion) VALUES (${crit2Id}, ${rubric1Id}, 'Uso de material didáctico y soporte visual', 35)`;
        const levels2 = [
        ...
        for (const l of levels2) {
            await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES (${l.id}, ${crit2Id}, ${l.desc}, ${l.pts})`;
        }
        // Rubric 1 - Criterion 3
        const crit3Id = '22222222-3333-3333-3333-111111111111';
        await (0, neon_1.default) `INSERT INTO criterios (id, rubrica_id, descripcion, ponderacion) VALUES (${crit3Id}, ${rubric1Id}, 'Manejo del tiempo y organización', 25)`;
        const levels3 = [
        ...
        for (const l of levels3) {
            await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES (${l.id}, ${crit3Id}, ${l.desc}, ${l.pts})`;
        }
    ...
    `;
        ...
        await (0, neon_1.default) `INSERT INTO criterios (id, rubrica_id, descripcion, ponderacion) VALUES (${critB1Id}, ${rubric2Id}, 'Rigurosidad del Algoritmo y Pseudocódigo', 50)`;
        await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES ('55555555-1111-1111-1111-222222222222', ${critB1Id}, 'Completo', 20)`;
        await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES ('55555555-1111-1111-1111-333333333333', ${critB1Id}, 'Incompleto', 10)`;
        // Rubric 2 - Crit 2
        const critB2Id = '55555555-2222-2222-2222-111111111111';
        await (0, neon_1.default) `INSERT INTO criterios (id, rubrica_id, descripcion, ponderacion) VALUES (${critB2Id}, ${rubric2Id}, 'Análisis de Complejidad Temporal', 50)`;
        await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES ('55555555-2222-2222-2222-222222222222', ${critB2Id}, 'Excelente', 20)`;
        await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES ('55555555-2222-2222-2222-333333333333', ${critB2Id}, 'Deficiente', 5)`;
    ...
    `;
        ...
        await (0, neon_1.default) `INSERT INTO criterios (id, rubrica_id, descripcion, ponderacion) VALUES (${critC1Id}, ${rubric3Id}, 'Argumentación Teórica', 100)`;
        await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES ('66666666-1111-1111-1111-222222222222', ${critC1Id}, 'Excelente', 20)`;
        await (0, neon_1.default) `INSERT INTO niveles (id, criterio_id, descripcion, puntos) VALUES ('66666666-1111-1111-1111-333333333333', ${critC1Id}, 'Insuficiente', 5)`;
